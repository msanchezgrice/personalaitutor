...
export function DashboardShell({
  ...
  operatorToolsHref: _operatorToolsHref = null,
  billingPortalEnabled: _billingPortalEnabled = false,
  children,
  decor,
  ...
  return (
    <>
      ...
      <div className="relative min-h-screen">
        <div
          data-dashboard-shell-content="1"
          data-dashboard-shell-locked={locked ? "1" : undefined}
          className={locked ? "pointer-events-none select-none opacity-35 blur-[5px]" : ""}
        >
          <div
            data-gemini-shell="1"
            ...
            <main className="flex-1 flex flex-col lg:h-full relative overflow-y-auto w-full min-w-0">
              ...
              >
                ...
                <div data-dashboard-header-settings="1" className="flex flex-shrink-0 items-center justify-end">
                  <DashboardSettingsMenu signedIn={Boolean(runtimeBootstrap?.auth.userId)} />
                </div>
              </header>
