...
export function DashboardProjectWorkbench({
  ...
  async function completeTutorSessionUi() {
    try {
      ...
      if (payload.generation && !payload.generation.ok) {
        setError(`Artifact generation failed (${payload.generation.failureCode}). No placeholder was created — retry or upload proof.`);
  ...
  async function queueArtifact(kind: "website" | "pdf" | "pptx") {
    ...
    try {
      ...
      setStatus(
        kind === "website"
          ? "Website generated from your real module work. Open it from the proof list below."
          : `${kind.toUpperCase()} generated from your real module work. Open it from the proof list below.`,
      );
          ...
          {!tutorSession ? (
            <div className="mt-4 space-y-4">
              <p className="text-sm leading-6 text-gray-300">
                The tutor walks you through this playbook step-by-step, checks off the proof checklist with you, and
                ends by generating a real artifact from your work. Progress is saved — you can leave and resume any time.
              </p>
              <button
                type="button"
              ...
              {tutorSession.status === "active" && tutorCurrentStep ? (
                <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
                  ...
                  <textarea
                    ...
                    rows={2}
                    placeholder="What did you do for this step? One concrete line of evidence."
                  ...
                  <button
                    type="button"
                    className="btn btn-primary mt-3 text-xs px-3 py-2"
              ...
              {tutorSession.status === "active" ? (
                <div className="rounded-2xl border border-emerald-500/20 bg-emerald-500/5 p-4">
                  ...
                  <p className="mt-2 text-xs leading-5 text-gray-400">
                    Completing the session can generate your artifact from everything you logged here — or attach your own
                    proof below instead.
                  </p>
        ...
        <div className="glass p-6 rounded-2xl border border-amber-500/20 bg-amber-500/5">
          ...
          <div className="mt-5 grid gap-3">
            ...
            >
              ...
              {busy === "website" ? "Generating Website..." : "Generate Website Proof"}
            </button>
            <div className="grid grid-cols-2 gap-3">
              ...
              <button
                ...
                disabled={!projectId || busy !== null}
              >
                {busy === "pptx" ? "Generating..." : "Generate Deck"}
              </button>
            </div>
            <a
              href="/dashboard/chat/"
